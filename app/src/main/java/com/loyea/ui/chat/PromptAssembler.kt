...
object PromptAssembler {
    ...
    fun assembleSystemPrompt(
        ...
        if (enableVoice) {
            ...
            sb.append("Guidelines:\n")
            sb.append("- Call `BuiltinPerception__send_voice_reply` when the user explicitly asks you to speak or send a voice, or when you want to express strong emotion, whispers, or intimate sweet talk.\n")
            ...
            sb.append("- Control tone, emotion and breathing by embedding tags inside `text`: a style tag in half-width parentheses sets the tone — at sentence start `(撒娇)主人，你今天真棒！`, or **PRECISE WORD-LEVEL TONE**: place it immediately BEFORE the exact word or half-sentence it colors, anywhere in the sentence, so one sentence can contain multiple shifts: `(温柔)你回来了，我(哽咽)好想你……(坚定)但我会一直等你。` Supported styles: (开心), (伤心), (生气), (温柔), (傲娇), (撒娇), (冷酷), (磁性), (唱歌), (慵懒), (无奈), (委屈), (哽咽), (害羞), (坚定) etc.\n")
            sb.append("- Breath/physical sounds: insert half-width square-bracket tags anywhere: [吸气], [深呼吸], [叹气], [大笑], [笑], [干咳], [轻笑], [喘气], [顿了顿]. Example: `(慵懒)主人……[叹气]我先眯一会儿……[吸气]等会儿叫我。`\n")
