...
object TavernCardCodec {
    ...
    /** 用于现有 UI 的旧 CharacterCard -> 标准文档转换。 */
    fun fromCharacterCard(card: CharacterCard): TavernCardDocument {
        val original = card.originalCardJson?.let(::parseJson)
        ...
        val data = TavernCardData(
            ...
            characterBook = card.characterBookJson?.let(::parseObjectOrNull)?.let(::parseBook)
